...
if ok <> "Y" then
  ...
  sHTML = ofv.FormHeader("PROVEEDORES")
  ...
  if rs.eof then
    ...
    Do While Not rs.EOF and posi < CantRegMostrarx
      ...
      if bSuprimir then
        ...
        sHref = sHref & "&Tabla=Provcorr&volver=" & vuelta & "&Eliminar=NSNC"
      ...
      if bModificar then
        ...
        sAccion = sAccion & "&tabla=Provcorr&volver=" & vuelta
  ...
  Agregar = ""
  if bAgregar then
    sAccion = "AgregarProveedores.asp?Regisvuelta=" & CantRegMoverx
    sAccion = sAccion & "&Opcion=si&tabla=Provcorr"
    Agregar = ofv.BotonAgregar(sAccion)
  end if

  str1 = "Select descri From Provcorr Order By descri "    ' orden pagina
  str2 = "Select descri From Provcorr Order By descri "  ' orden alfabetico
