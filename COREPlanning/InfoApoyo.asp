...
if ok <> "Y" then
  ...
  sHTML = ofv.FormHeader("INFORMACION DE APOYO")
  ...
  if rs.eof then
    ...
    Do While Not rs.EOF and posi < CantRegMostrarx
      ...
      if bSuprimir then
        ...
        sHref = sHref & "&Tabla=IAR&volver=" & vuelta & "&Eliminar=NSNC"
      ...
      if bModificar then
        ...
        sAccion = sAccion & "&tabla=IAR&volver=" & vuelta
  ...
  Agregar = ""
  if bAgregar then
    sAccion = "AgregarInfoApoyo.asp?Regisvuelta=" & CantRegMoverx
    sAccion = sAccion & "&Opcion=si&tabla=IAR"
    Agregar = ofv.BotonAgregar(sAccion)
  end if

  str1 = "Select descri From Iar Order By descri "    ' orden pagina
  str2 = "Select descri From Iar Order By descri "  ' orden alfabetico
