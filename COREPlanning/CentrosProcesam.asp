...
if ok <> "Y" then
  ...
  sHTML = ofv.FormHeader("CENTROS DE PROCESAMIENTO")
  ...
  Else
    ...
    Do While Not rs.EOF and posi < CantRegMostrarx
      ...
      if bSuprimir then
        ...
        sHref = sHref & "&Tabla=Cenproccorr&volver=" & vuelta & "&Eliminar=NSNC"
      ...
      if bModificar then
        ...
        sAccion = sAccion & "&tabla=Cenproccorr&volver=" & vuelta
  ...
  Agregar = ""
  if bAgregar then
    sAccion = "AgregarCentrosProcesam.asp?Regisvuelta=" & CantRegMoverx
    sAccion = sAccion & "&Opcion=si&tabla=Cenproccorr"
    Agregar = ofv.BotonAgregar(sAccion)
  end if

  str1 = "Select descri From Cenproccorr Order by Descri "    ' orden pagina
  str2 = "Select descri From Cenproccorr Order by Descri "  ' orden alfabetico
