...
if ok <> "Y" then
  ...
  sHTML = ofv.FormHeader("AGREGAR INFORMACION DE BASE")
  ...
  sAccion = sAccion & "&volver=../InfoBase.asp?CantRegMover=" & Regisvuelta
  ...
  'Aceptar y Cancelar
  sAccion = "InfoBase.asp?CantRegMover=" & Regisvuelta
