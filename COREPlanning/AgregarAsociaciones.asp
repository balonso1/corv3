...
if ok <> "Y" then
  ...
  sHTML = ofv.FormHeader("AGREGAR ASOCIACIONES")
  ...
  sAccion = sAccion & "&volver=../Asociaciones.asp?CantRegMover=" & Regisvuelta
  ...
  'Aceptar y Cancelar
  sAccion = "Asociaciones.asp?CantRegMover=" & Regisvuelta
