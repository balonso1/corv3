...
if ok <> "Y" then
  ...
  sHTML = ofv.FormHeader("AGREGAR INFORMACION DE APOYO")
  ...
  sAccion = sAccion & "&volver=../InfoApoyo.asp?CantRegMover=" & Regisvuelta
  ...
  'Aceptar y Cancelar
  sAccion = "InfoApoyo.asp?CantRegMover=" & Regisvuelta
