...
if Session("CorApli") = "COREM20" and Session("noved") <> "SI" then
...
sHTML = sHTML & " document.all['L02'].style.left = 80 + 40 + 90; "
...
sHTML = sHTML & " document.all['AP'].style.width = document.body.clientWidth  - 10; "
sHTML = sHTML & " document.all['AP'].style.left = (document.body.clientWidth  - document.all['AP'].clientWidth) / 2; "
sHTML = sHTML & " document.all['AP'].style.top  = (document.body.clientHeight - document.all['AP'].clientHeight) / 2; "
sHTML = sHTML & "  }"
...
<v:rect id='L0' style="visibility:hidden;position:absolute;top:400;left:200;width:35;height:35;" > 
  <v:fill on="True" type="frame" src="imagenes/corlogox1.jpg" opacity="95%"  /> 
  <v:extrusion on="True" backdepth="-15" color="#FFFFFF" color2="#FFFFFF" metal="true"   rotationcenter="0,0,0"  
   rotationangle = "0,0" opacity="10%" />
     ...
     <v:roundrect id='AP'  style='visibility:hidden;z-index:4;position:absolute;left:435px;top:485px;width:150px;height:40px;' >
       <v:stroke on="false" />	
       <v:fill on="false" color="#336699" color2="#FFFFFF" type="gradient" angle="30" opacity="20%"  />
	<v:textbox style="font-size:10pt;font-family:tahoma;font-weight:bold;color:#FFFFFF;text-align:center;" ><%=saplic%></v:textbox>
     </v:roundrect >

 <v:line id='L02' from='0,0' to='1,0' style='visibility:hidden;z-index:1;position:absolute;left:435px;top:485px;width:80px;height:20px;' > 
   ...
   <v:path textpathok='True' /> 
     <v:textpath on='True' string='Cor Consulting' style="font-size:'18pt';font-family:'helvetica';font-weight:bold;"  /> 
   <v:extrusion on='false' backdepth='2' color='#ffffff' metal='True'  rotationcenter='0,0,0'  rotationangle = '0,0' /> 
 </v:line>
 ...
 <a class=nt style='visibility:hidden;' href='http://www.corconsulting.com.ar' target='_blank' >
 <v:line id='L2' from='0,0' to='1,0' style='visibility:hidden;z-index:1;position:absolute;left:135px;top:385px;width:80px;height:20px;' > 
