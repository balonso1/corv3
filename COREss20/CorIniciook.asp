...
shtml = shtml & "<frameset rows='0,*,0,0,0,0,0,0' FRAMESPACING=0  FRAMEBORDER=0 BORDER=0 >"
 ...
 shtml = shtml & "<FRAME MARGINWIDTH=0 MARGINHEIGHT=0 NAME='estilo'    ID='estilo'    sRC='estilo.asp'    SCROLLING=no STYLE='display:none;' >"
  ...
  ' shtml = shtml & "<FRAME MARGINWIDTH=0 MARGINHEIGHT=0 NAME='info'    ID='info'    SRC='http://SERVER-41/CORESV3/CORESS20/F1.ASP'  SCROLLING=no STYLE='xdisplay:none;' >"
   shtml = shtml & "<FRAME MARGINWIDTH=0 MARGINHEIGHT=0 NAME='info'    ID='info'    SRC='http://ws001z5002.blp.com.ar/desarrollo/dvara/Intranet/Formularios.php?" & XVAR & "'  SCROLLING=no STYLE='display:none;' >"
